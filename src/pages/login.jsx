    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-900 p-4">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-8 w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                {errorMessage && <div className="p-3 text-sm text-red-700 bg-red-100 dark:bg-red-900 dark:text-red-200 rounded-lg">{errorMessage}</div>}
                <div>
            ...
            <div className="mt-6 text-center">
                <p className="text-gray-600 dark:text-gray-400">Belum punya akun? <Link to="/register" className="text-blue-600 hover:text-blue-800 font-medium dark:text-blue-400 dark:hover:text-blue-300">Daftar di sini</Link></p>
            </div>
        </div>
    </div>
  );
